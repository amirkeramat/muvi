    ...
    <>
      {loading === "fulfilled" ? (
        <div className='bg-zinc-950 h-full'>
          <div className='h-screen w-full after:absolute after:content-[""] after:bottom-0 after:h-[300px]  after:md:h-[250px] after:w-full after:left-0 after:bg-gradient-to-t after:via-zinc-900/90 after:to-zinc-900/5  after:from-zinc-950 overflow-hidden'>
            <img src={`${BACK_DROP_ORIGINAL}/${backdropPath}`} alt='' />
            {/* <LazyLoadImage
